    ...
    {:else if tasksQuery.current}
      <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {#each tasksQuery.current as task (task.id)}
          ...
          >
            <div
              class="absolute inset-0 bg-gradient-to-br from-primary/5 via-secondary/5 to-primary/10 opacity-30 transition-opacity duration-300 group-hover:opacity-50"
            ></div>
            ...
            <Card.Header class="relative">
              ...
              <Card.Title class="mt-3 flex items-start gap-2 text-lg">
                <ListTodo class="mt-0.5 h-5 w-5 flex-shrink-0 text-primary" />
