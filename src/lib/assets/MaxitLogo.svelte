<script lang="ts">
  ...
  let { width = 24, height = 24, primaryColor = false, clickable = true } = $props();
  ...
  const homeUrl = localizeHref(AppRoutes.Home);
</script>
...
{#if clickable}
  <a href={homeUrl} class="inline-block cursor-pointer transition-opacity hover:opacity-80">
    {@render logoContent()}
  </a>
{:else}
  {@render logoContent()}
